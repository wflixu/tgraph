...
export declare class ThGraph extends ThEventSource {
    /**
    ...
    view: any;
    graphModelChangeListener: (sender: any, evt: any) => void;
   ...
   */
     ...
     */
    createSelectionModel(): ThGraphSelectionModel;
    /**
     * Function: setSelectionModel
     *
     * Sets the <mxSelectionModel> that contains the selection.
     */
    setSelectionModel(selectionModel: ThGraphSelectionModel): void;
    /**
     * Function: setStylesheet
     *
     * Sets the <ThStylesheet> that defines the style.
     */
    setStylesheet(stylesheet: ThStylesheet): void;
    /**
     * Function: createStylesheet
     *
     * Creates a new <mxGraphSelectionModel> to be used in this graph.
     */
    createStylesheet(): ThStylesheet;
}
