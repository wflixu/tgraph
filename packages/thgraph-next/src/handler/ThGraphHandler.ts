...
export class ThGraphHandler {
    ...
    panHandler: () => void;
    suspended: any;
    escapeHandler: (sender: any, evt: any) => void;
    refreshThread: any;
    livePreviewUsed: any;
    first: null;
    bounds: any;
    ...
    isDelayedSelection(cell, me) {
        ...
        return (
            this.graph.isToggleEvent(me.getEvent()) && !ThEvent.isAltDown(me.getEvent())
        );
    };
     ...
     * {
     *   var source = ThEvent.getSource(me.getEvent());
     *
     *   if (!ThEvent.isTouchEvent(me.getEvent()) || source.nodeName != 'A')
     *   {
     *     me.consume();
     *   }
     * }
    ...
    mouseDown(sender, me) {
        if (
            ...
            me.getState() != null &&
            !ThEvent.isMultiTouchEvent(me.getEvent())
        ) {
            ...
            if (this.isMoveEnabled()) {
                ...
                this.consumeMouseEvent(ThEvent.MOUSE_DOWN, me);
            }
        }
    };
    ...
    createPreviewShape(bounds) {
        ...
        if (this.htmlPreview) {
            ...
            shape.dialect = ThConstants.DIALECT_SVG;
    ...
    mouseMove(sender, me) {
        ...
        if (
            ...
            if (ThEvent.isMultiTouchEvent(me.getEvent())) {
                this.reset();
                return;
            }
            ...
            this.updateHint(me);
            this.consumeMouseEvent(ThEvent.MOUSE_MOVE, me);

            // Cancels the bubbling of events to the container so
            // that the droptarget is not reset due to an mouseMove
            // fired on the container with no associated state.
            ThEvent.consume(me.getEvent());
        } else if (
     ...
     */
    updatePreview(remote: boolean = false) {
    ...
    mouseUp(sender, me) {
        ...
        if (this.cellWasClicked) {
            this.consumeMouseEvent(ThEvent.MOUSE_UP, me);
        }
        ...
        if (this.graph.getModel().isVertex(parent)) {
            ...
            if (pState != null) {
                var pt = mxUtils.convertPoint(
                    ...
                    ThEvent.getClientX(evt),
                    ThEvent.getClientY(evt),
                );
    ...
    destroy() {
        ...
        ThEvent.removeListener(document, 'keydown', this.keyHandler);
        ThEvent.removeListener(document, 'keyup', this.keyHandler);
