...
export class ThGraphView extends ThEventSource {
    /**
     *
     */
    EMPTY_POINT = new ThPoint();
    ...
    constructor(graph: ThGraph) {
        super();
        this.graph = graph;
        this.translate = new ThPoint();
        this.graphBounds = new ThRectangle(0,0);
        this.states = new Map();
    }
     ...
     * Sets <graphBounds>.
     */
    setGraphBounds(value: ThRectangle) {
     ...
     */
//     getBounds(cells: string | any[] | null) {
//         var result = null;
...
//                     if (state != null) {
//                         if (result == null) {
//                             result = ThRectangle.fromRectangle(state);
//                         } else {
//                             result.add(state);
//                         }
//                     }
...
//      */
//     setCurrentRoot(root: null) {
//         if (this.currentRoot != root) {
//             var change = new mxCurrentRootChange(this, root);
//             change.execute();
//             var edit = new mxUndoableEdit(this, true);
//             edit.add(change);
//             this.fireEvent(new mxEventObject(ThEvent.UNDO, 'edit', edit));
...
//         var previousTranslate = new ThPoint(this.translate.x, this.translate.y);
...
//      * recursion.
//      */
//     clear(cell: null | undefined, force: boolean | null | undefined, recurse: null | undefined) {
//         var model = this.graph.getModel();
...
//      * model.
//      */
//     invalidate(cell: { invalidating: boolean; } | undefined, recurse: null | undefined, includeEdges: null | undefined) {
//         var model = this.graph.getModel();
//         cell = cell || model.getRoot();
//         recurse = recurse != null ? recurse : true;
...
//      */
//     validate(cell: undefined) {
//         var t0 = mxLog.enter('ThGraphView.validate');
//         window.status =
...
//         mxLog.leave('ThGraphView.validate', t0);
//     };
...
//      * Default is true.
//      */
//     getBoundingBox(state: { shape: { boundingBox: { clone: () => any; } | null; } | null; text: { boundingBox: { clone: () => any; } | null; } | null; cell: any; } | null, recurse: null | undefined) {
//         recurse = recurse != null ? recurse : true;
//         var bbox = null;
...
//      * Parameters:
//      *
//      * bounds - <ThRectangle> that represents the bounds of the shape.
//      */
//     createBackgroundPageShape(bounds: ThRectangle) {
...
//                 var bounds = new ThRectangle(0, 0, 1, 1);
...
//                         if (this.graph.isMouseDown && !ThEvent.isConsumed(evt)) {
//                             this.graph.fireMouseEvent(
//                                 ThEvent.MOUSE_MOVE,
//                                 new mxMouseEvent(evt),
//                             );
...
//      */
//     redrawBackgroundImage(backgroundImage: { scale: number; bounds: { x: number; y: number; width: number; height: number; }; redraw: () => void; }, bg: { width: number; height: number; }) {
...
//      * is true.
//      */
//     validateCell(cell: null, visible: null | undefined) {
...
//      */
//     validateCellState(cell: null, recurse: boolean | null | undefined) {
//         recurse = recurse != null ? recurse : true;
//         var state = null;
...
//      */
//     updateCellState(state: { absoluteOffset: { x: number; y: number; }; origin: { x: number; y: number; }; length: number; cell: null; x: number; y: number; width: number; unscaledWidth: any; height: number; unscaledHeight: any; updateCachedBounds: () => void; }) {
...
//      */
//     updateVertexState(state: { cell: any; getCenterX: () => number | undefined; getCenterY: () => number | undefined; x: number; width: number; y: number; height: number; }, geo: { relative: any; }) {
//         var model = this.graph.getModel();
//         var pState = this.getState(model.getParent(state.cell));
...
//                 var ct = new ThPoint(state.getCenterX(), state.getCenterY());
//                 var cx = new ThPoint(pState.getCenterX(), pState.getCenterY());
...
//      * Validates the given cell state.
//      */
//     updateEdgeState(state: { getVisibleTerminalState: (arg0: boolean) => any; cell: null; absolutePoints: any; }, geo: { getTerminalPoint: (arg0: boolean) => null; points: any; }) {
...
//      */
//     updateVertexLabelOffset(state: { style: any; width: number; absoluteOffset: { x: number; y: number; }; height: number; }) {
...
//      */
//     updateFixedTerminalPoints(edge: any, source: any, target: any) {
...
//      */
//     updateFixedTerminalPoint(edge: { setAbsoluteTerminalPoint: (arg0: any, arg1: any) => void; }, terminal: any, source: boolean, constraint: any) {
...
//      * constraint - <mxConnectionConstraint> that specifies the connection.
//      */
//     getFixedTerminalPoint(edge: { origin: any; cell: any; }, terminal: null, source: any, constraint: null) {
//         var pt = null;
...
//      * if it has a fixed aspect and returns the previous bounds as an <ThRectangle> if
...
//      */
//     updateBoundsFromStencil(state: { shape: { stencil: { aspect: string; computeAspect: (arg0: any, arg1: any, arg2: any, arg3: any, arg4: any) => any; w0: number; h0: number; } | null; } | null; style: any; x: any; y: any; width: any; height: any; setRect: (arg0: any, arg1: any, arg2: number, arg3: number) => void; } | null) {
//         var previous = null;
...
//         ) {
//             previous = ThRectangle.fromRectangle(state);
...
//      */
//     updatePoints(edge: { absolutePoints: any[]; } | null, points: string | any[] | null, source: any, target: any) {
//         if (edge != null) {
//             var pts = [];
...
//      */
//     transformControlPoint(state: { origin: any; } | null, pt: { x: number; y: number; } | null, ignoreScale: undefined) {
...
//      * associated.
//      */
//     isLoopStyleEnabled(edge: { style: any; }, points: string | any[] | null, source: null, target: any) {
...
//      */
//     getEdgeStyle(edge: { style: { [x: string]: any; }; }, points: any, source: any, target: any) {
...
//      * target - <mxCellState> that represents the target terminal.
//      */
//     updateFloatingTerminalPoints(state: { absolutePoints: any; }, source: null, target: null) {
//         var pts = state.absolutePoints;
//         var p0 = pts[0];
...
//      */
//     updateFloatingTerminalPoint(edge: { setAbsoluteTerminalPoint: (arg0: any, arg1: any) => void; }, start: any, end: any, source: boolean) {
//         edge.setAbsoluteTerminalPoint(
...
//      * source - Boolean indicating if start is the source terminal state.
//      */
//     getFloatingTerminalPoint(edge: { style: { [x: string]: any; }; }, start: { style: { [x: string]: any; }; getCenterX: () => number | undefined; getCenterY: () => number | undefined; }, end: any, source: any) {
...
//         );
//         var center = new ThPoint(start.getCenterX(), start.getCenterY());
...
//      */
//     getTerminalPort(state: { style: any; }, terminal: any, source: boolean) {
//         var key = source
...
//      *
//      * Returns an <ThPoint> that defines the location of the intersection point between
//      * the perimeter and the line between the center of the shape and the given point.
//      *
//      * Parameters:
//      *
//      * terminal - <mxCellState> for the source or target terminal.
//      * next - <ThPoint> that lies outside of the given terminal.
...
//      */
//     getPerimeterPoint(terminal: { cell: any; style: any; shape: { stencil: null; } | null; } | null, next: { x: number | undefined; y: number | undefined; } | null, orthogonal: any, border: number) {
//         var point = null;
...
//                     point = new ThPoint(next.x, next.y);
//                     var flipH = false;
//                     var flipV = false;
...
//      */
//     getRoutingCenterX(state: { style: { [x: string]: string; } | null; getCenterX: () => number; width: number; }) {
//         var f =
//             state.style != null
...
//      */
//     getRoutingCenterY(state: { style: { [x: string]: string; } | null; getCenterY: () => number; height: number; }) {
//         var f =
//             state.style != null
...
//      */
//     getPerimeterBounds(terminal: { style: { [x: string]: any; }; getPerimeterBounds: (arg0: number) => any; } | null, border: number | null) {
...
//      */
//     getPerimeterFunction(state: { style: { [x: string]: any; }; }) {
...
//      * should be returned.
//      */
//     getNextPoint(edge: { absolutePoints: any; }, opposite: { getCenterX: () => number | undefined; getCenterY: () => number | undefined; } | null, source: any) {
...
//             point = new ThPoint(opposite.getCenterX(), opposite.getCenterY());
//         }
...
//      * should be returned.
//      */
//     getVisibleTerminal(edge: any, source: boolean) {
//         var model = this.graph.getModel();
...
//      */
//     updateEdgeBounds(state: { absolutePoints: any; terminalDistance: number; length: number; segments: number[]; x: any; y: any; width: number; height: number; }) {
...
//      * <mxGeometry> as an <ThPoint>. The edge is represented by the given
//      * <mxCellState>.
//      *
//      * Parameters:
//      *
...
//      */
//     getPoint(state: { getCenterX: () => any; getCenterY: () => any; segments: any[] | null; absolutePoints: string | any[]; length: number; }, geometry: { relative: any; x: number; y: number; offset: any; } | null | undefined) {
...
//      */
//     getRelativePoint(edgeState: { cell: any; absolutePoints: string | any[]; length: any; segments: any; }, x: any, y: any) {
//         var model = this.graph.getModel();
...
//      * state - <mxCellState> whose absolute offset should be updated.
//      */
//     updateEdgeLabelOffset(state: { absolutePoints: any; absoluteOffset: ThPoint; getCenterX: () => any; getCenterY: () => any; segments: null; cell: any; }) {
//         var points = state.absolutePoints;
...
//      */
//     getState(cell: string | null, create: boolean | undefined) {
//         create = create || false;
//         var state = null;
...
//      * Sets <states>.
//      */
//     setStates(value: Map<string, any>) {
//         this.states = value;
//     };
...
//      * this returns <states>.
//      */
//     getCellStates(cells: string | any[] | null) {
//         if (cells == null) {
//             return this.states;
//         } else {
//             var result = [];
...
//      */
//     isScrollEvent(evt: { clientX: number; clientY: number; }) {
//         var offset = mxUtils.getOffset(this.graph.container);
//         var pt = new ThPoint(evt.clientX - offset.x, evt.clientY - offset.y);
...
//             var pointerId: null = null;

//             // Adds basic listeners for graph event dispatching
//             ThEvent.addGestureListeners(
//                 container,
//                 mxUtils.bind(this, function (evt: { pointerId: any; }) {
...
//                     ) {
//                         graph.fireMouseEvent(ThEvent.MOUSE_DOWN, new mxMouseEvent(evt));
...
//                     ) {
//                         graph.fireMouseEvent(ThEvent.MOUSE_MOVE, new mxMouseEvent(evt));
//                     }
//                 }),
//                 mxUtils.bind(this, function (evt: any) {
//                     if (this.isContainerEvent(evt)) {
//                         graph.fireMouseEvent(ThEvent.MOUSE_UP, new mxMouseEvent(evt));
//                     }
...
//             this.moveHandler = mxUtils.bind(this, function (evt: any) {
//                 // Hides the tooltip if mouse is outside container
//                 if (
...
//             this.endHandler = mxUtils.bind(this, function (evt: any) {
//                 if (
//                     this.captureDocumentGesture &&
//                     graph.isMouseDown &&
//                     graph.container != null &&
...
//      */
//     updateHtmlCanvasSize(width: string | number, height: string | number) {
...
//      */
//     createHtmlPane(width: string | null, height: string | null) {
...
//      */
//     updateContainerStyle(container: { style: { position: string; touchAction: string; }; }) {
...
//             ThEvent.removeGestureListeners(
//                 document,
//                 null,
//                 this.moveHandler,
//                 this.endHandler,
//             );
//             ThEvent.release(this.graph.container);
...
//     constructor(view: this, root: null) {
//         this.view = view;
//         this.root = root;
//         this.previous = root;
//         this.isUp = root == null;
...
//         if (translate != null) {
//             this.view.translate = new ThPoint(-translate.x, -translate.y);
//         }
...
//         var name = this.isUp ? ThEvent.UP : ThEvent.DOWN;
//         this.view.fireEvent(
//             new mxEventObject(
//                 name,
//                 'root',
...
console.log('graph/view/ThGraphView.js');
