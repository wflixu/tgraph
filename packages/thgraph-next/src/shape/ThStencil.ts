...
//  import { mxShape } from './mxShape.js';
 ...
 export class ThStencil extends ThShape {
   /**
...
//      if ((ThStencil.defaultLocalized && loc == null) || loc == '1') {
...
//        if (text != null && ThStencil.allowEval) {
