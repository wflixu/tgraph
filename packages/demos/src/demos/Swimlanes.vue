...
const keyhandlerCommons = `<mxEditor>
...
function main(container) {
  ...
  // keyboard bindings
  var config = mxUtils.parseXml(keyhandlerCommons).documentElement;
  ...
  try {
    ...
    var step111 = graph.insertVertex(
      lane1a,
      null,
      'Receive and\nAcknowledge',
      385,
    ...
    var step444 = graph.insertVertex(
      lane2a,
      null,
      'Tap for gas\ndelivery?',
      480,
