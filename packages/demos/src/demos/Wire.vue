...
function main(container) {
  ...
  try {
    var v1 = graph.insertVertex(
      ...
      40,
      80,
      'verticalLabelPosition=top;verticalAlign=bottom;shadow=1;fillColor=' +
        fillColor,
    );
    ...
    v19.style =
      'shape=triangle;direction=north;spacingBottom=12;align=center;portConstraint=horizontal;' +
      'fontSize=8;strokeColor=' +
      strokeColor +
      ';routingCenterY=0.5;';
  ...
  graph.connectionHandler.isStartEvent = function (me) {
    return (
      checkbox.checked || connectionHandlerIsStartEvent.apply(this, arguments)
    );
  };
  ...
  graph.connectionHandler.mouseUp = function (sender, me) {
    if (this.first != null && this.previous != null) {
      ...
      if (dx < this.graph.tolerance && dy < this.graph.tolerance) {
        ...
        if (
          !checkbox.checked &&
          this.graph.getModel().isEdge(this.previous.cell)
        ) {
          this.reset();
        }
...
function updatesConnectionPoints() {
...
function overrideMethods() {
  ...
  mxConnectionHandlerUpdateCurrentState =
...
function highlighting() {
  let mxConnectionHandlerCreateMarker =
  ...
  mxEdgeHandler.prototype.createMarker = function () {
    ...
    marker.highlight.highlight =
      this.graph.connectionHandler.marker.highlight.highlight;
  ...
  ResistorShape.prototype.redrawPath = function (
    path,
    x,
    y,
    w,
