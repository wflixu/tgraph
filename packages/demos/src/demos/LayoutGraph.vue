...
function main(container) {
  ...
  toolbar.insertBefore(
    mxUtils.button('Circle Layout', function (evt) {
  ...
  // Adds a button to execute the layout
  toolbar.insertBefore(
    mxUtils.button('Organic Layout', function (evt) {
      graph.getModel().beginUpdate();
      try {
...
<template>
  <p>
    ...
    Graphlayout example for mxGraph. This example demonstrates using automatic
    graph layouts and listening to changes of the graph size to keep the
    container size in sync.
  </p>
