...
export class mxConstraintHandler {
     ...
     */
    pointImage = new mxImage(pointGif, 5, 5);
     ...
     */
    getCellForEvent = function (me, point) {
        var cell = me.getCell();
     ...
     * are ignored.
     */
    setFocus = function (me, state, source) {
     ...
     */
    intersects = function (icon, mouse, source, existingEdge) {
