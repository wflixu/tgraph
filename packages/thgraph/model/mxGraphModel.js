...
export class mxGraphModel extends mxEventSource {
   ...
   * Default is false.
   */
  getChildCells = function (parent, vertices, edges) {
   ...
   * target terminal of the edge.
   */
  terminalForCellChanged = function (edge, terminal, isSource) {
   ...
   */
  createUndoableEdit = function (significant) {
   ...
   */
  cloneCell = function (cell, includeChildren) {
    if (cell != null) {
   ...
   */
  cloneCells = function (cells, includeChildren, mapping) {
