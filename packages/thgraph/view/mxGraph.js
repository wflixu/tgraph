...
import expandedGif from '../assets/expand.gif' assert { type: 'image/gif'};
import collapsedGif from '../assets/collapse.gif' assert { type: 'image/gif'};
/**
 * Class: mxGraph
 *
...
export class mxGraph extends mxEventSource {
   ...
   */
  collapsedImage = new mxImage(collapsedGif, 9, 9);
   ...
   */
  expandedImage = new mxImage(expandedGif, 9, 9);
   ...
   */
  warningImage = new mxImage(warning, 16, 16);
  ...
  fireMouseEvent(evtName, me, sender) {
    ...
    if (!this.nativeDblClickEnabled && !mxEvent.isPopupTrigger(me.getEvent())) {
