...
export class mxShape {
  ...
  // 	delete this.fill = undefined;
  // 	delete this.gradient = undefined;
  // 	delete this.gradientDirection = undefined;
  // 	delete this.stroke = undefined;
